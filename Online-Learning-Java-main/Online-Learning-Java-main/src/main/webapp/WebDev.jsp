...
<body>
	...
	<div class="course-container">
		<div class="left-section">
			<img class="thumbnail" src="Images/Group 7.png"
		...
		<div class="right-section">
			<p class="price">
				Price <span class="highlight">₹4000</span> <span class="discounted">₹8000</span>
				(+ GST)
			</p>
			<p>Limited Time Discount Applied!</p>
		    <a href="Payment6.jsp" class="buy-btn">Buy Now</a>
			<p>
				Batch Starts on <span class="highlight">27th January</span>
			</p>
			</br> </br>
            <a href="https://www.youtube.com/watch?v=yG8JMlldoCE" target="_blank" class="buy-btn">Learn Basics on Web Dev Cohort</a>
		</div>
	</div>
	...
	<img alt="" src="Images/image 9.png">
		<h1 class="title">Syllabus</h1>
		<p class="subtitle">
			Dominate. From <span class="highlight">Start</span> to Victory.
		</p>
            <a href="WebDev_syllabus.jsp" class="btn">View Complete Syllabus</a><br><br>
	</div>

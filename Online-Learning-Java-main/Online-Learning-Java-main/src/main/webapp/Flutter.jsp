...
<body>
	...
	<div class="container">
		<h1>Online Flutter <span class="highlight">App</span> Development Course</h1><br>
		<br><br>
		<div class="buttons">
			<button class="button">Basics</button>
			<button class="button">Flutter</button>
			<button class="button">Firebase Components</button>
		</div>
	</div>
	...
	<div class="course-container">
		<div class="left-section">
			<img class="thumbnail" src="Images/Group 35.png"
		...
		<div class="right-section">
		    ...
		    <a href="Payment3.jsp" class="buy-btn">Buy Now</a>
			<p>
				Batch Starts on <span class="highlight">27th January</span>
			</p>
			</br> </br>
            <a href="https://www.youtube.com/watch?v=jqxz7QvdWk8&list=PLjVLYmrlmjGfGLShoW0vVX_tcyT8u1Y3E" target="_blank" class="buy-btn">Learn Basics on Flutter</a>
		</div>
	</div>
	...
	<div class="roadmap">
		<img alt="" src="Images/Group 109.png">
	</div>
	...
	<div class="container2">
		...
		<p class="subtitle">
            ...
            <a href="Flutter_syllabus.jsp" class="btn">View Complete Syllabus</a><br><br>
	</div>

...
<body>
   ...
   <div class="navbar">
    ...
    <div class="container">
        <h1>Job Ready <span class="highlight">AI</span> Powered Cohort:</h1><br>
        <h2>Complete Web Development + DSA + Aptitude</h2><br>
        <div class="buttons">
            <button class="button">MERN Stack</button>
            <button class="button">DSA With JS</button>
            <button class="button">AI Powered</button>
            <button class="button">Placement Focus</button>
            <button class="button">Aptitude</button>
        </div>
    </div>
    ...
    <div class="course-container">
        <div class="left-section">
            <img class="thumbnail" src="Images/Group 30.png" alt="Course Thumbnail">
        ...
        <div class="right-section">
            <p class="price">Price <span class="highlight">₹5999</span> <span class="discounted">₹11999</span> (+ GST)</p>
            <p>Limited Time Discount Applied!</p>
            <a href="Payment1.jsp" class="buy-btn">Buy Now</a> </br>
            <p>Batch Starts on <span class="highlight">27th January</span></p>
            
            </br> </br>
            <a href="https://www.youtube.com/watch?v=Vi9bxu-M-ag&list=PLDzeHZWIZsTo0wSBcg4-NMIbC0L8evLrD" target="_blank" class="buy-btn">Learn Basics on WebDevlopment</a>
        </div>
    </div>
    ...
    <h1 class="gradient-text">Zero To Job-Ready</h1><br>
    <h2 class="sub-text">in 5 months*</h2><br>
    <h3 class="small-text">What you will learn</h3>
    
    
    <div class="roadmap">
       <img alt="" src="Images/Group 67.png">
    </div>
    
    
     <div class="container2">
        <h1 class="title">Syllabus</h1>
        <p class="subtitle">Dominate. From <span class="highlight">Start</span> to Victory.</p>
            <a href="WebDevlopment_syllabus.jsp" class="btn">View Complete Syllabus</a><br><br> 
    </div>

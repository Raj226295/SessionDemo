...
<head>
<meta charset="UTF-8">
<title>Web Development Master</title>
...
<body>
   ...
   <div class="navbar">
    ...
    <div class="container">
        <h1>Web Development <span class="highlight">master</span></h1><br>
        <h1>Course @dot 1.0 Batch</h1><br>
        <div class="buttons">
            <button class="button">React.js</button>
            <button class="button">Node.js</button>
            <button class="button">Express.js</button>
            <button class="button">MongoDB</button>
            <button class="button">project-focused</button>
        </div>
    </div>
    ...
    <div class="course-container">
        <div class="left-section">
            <img class="thumbnail" src="Images/Group 31.png" alt="Course Thumbnail">
        ...
        <div class="right-section">
		    ...
		    <a href="Payment4.jsp" class="buy-btn">Buy Now</a>
            <p>Batch Starts on <span class="highlight">27th January</span></p>
            </br> </br>
            <a href="https://www.youtube.com/watch?v=GxmfcnU3feo" target="_blank" class="buy-btn">Learn Basics on Web Dev Master</a>
        </div>
    </div>
    ...
    <div class="roadmap">
       <img alt="" src="Images/Group 60.png">
    </div>
     ...
     <div class="container2">
        ...
        <p class="subtitle">Dominate. From <span class="highlight">Start</span> to Victory.</p>
            <a href="WebDevMaster_syllabus.jsp" class="btn">View Complete Syllabus</a><br><br>
    </div>

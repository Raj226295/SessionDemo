...
<body>
   ...
   <div class="navbar">
    ...
    <div class="container">
        <h1>Complete <span class="highlight">nodejs</span> + <span class="highlight">expressjs</span> + <span class="highlight">mongodb</span></h1><br>
       <br>
        <div class="buttons">
    ...
    <div class="course-container">
        <div class="left-section">
            <img class="thumbnail" src="Images/Group 32.png" alt="Course Thumbnail">
        ...
        <div class="right-section">
		    ...
		    <a href="Payment5.jsp" class="buy-btn">Buy Now</a>
            <p>Batch Starts on <span class="highlight">27th January</span></p>
            </br> </br>
            <a href="https://www.youtube.com/watch?v=ooBxSg1Cl1w" target="_blank" class="buy-btn">Learn Basics on Nodejs</a>
        </div>
    </div>
    ...
    <div class="roadmap">
     ...
     <div class="container2">
        ...
        <p class="subtitle">Dominate. From <span class="highlight">Start</span> to Victory.</p>
            <a href="Nodejs_syllabus.jsp" class="btn">View Complete Syllabus</a><br><br>
    </div>

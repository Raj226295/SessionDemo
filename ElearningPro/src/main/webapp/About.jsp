    ...
    <style>
		...
		* {
		...
		.navbar .logo {
             font-size: 28px;
             font-weight: bold;
             color: white;   /* Logic white */
        }

        .logo span {
             color: purple;  /* Hub purple */
        }
        ...
        .leader-card img {
            ...
            border-radius: 20px;
            object-fit: cover;
            object-position: center top; /* try center / center top */
}
...
<body>
     <div class="navbar">
        <h1 class="logo">Logic<span>Hub</span></h1>
        <div>
    ...
    <div class="footer-left">
        <div class="footer-logo">Logic<span>Hub</span></div>

        <div class="social-icons">
            <a href="#"><img src="Images/communication 1.png"></a>
            <a href="#"><img src="Images/social 1.png"></a>
            <a href="#"><img src="Images/linkedin 1.png"></a>
            <a href="#"><img src="Images/youtube 1.png"></a>
        </div>
    </div>
